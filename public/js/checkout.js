...
function getTherapist(_0x5d0287) {
    ...
    $[_0x1caa33(0x177)]({
        ...
        'success': function(_0x218563) {
            ...
            $(_0x464c0c(0x18e))[_0x464c0c(0x196)]('' + parseFloat(therapistInformation[_0x464c0c(0x174)] * _0x4788c1)[_0x464c0c(0x17b)](0x2)), $(_0x464c0c(0x1bd))[_0x464c0c(0x196)]('' + parseFloat(therapistInformation[_0x464c0c(0x174)] * _0x4788c1)['toFixed'](0x2)), $(_0x464c0c(0x1a8))[_0x464c0c(0x196)]('Kshs.' + parseFloat(therapistInformation[_0x464c0c(0x174)] * _0x4788c1 * 0.12)[_0x464c0c(0x17b)](0x2)), $(_0x464c0c(0x1b0))[_0x464c0c(0x196)]('Kshs.' + parseFloat(therapistInformation['sessionCost'] * _0x4788c1 * 1.12)[_0x464c0c(0x17b)](0x2));
        }
    });
}
    ...
    $(_0x46497d(0x1ba))[_0x46497d(0x1a2)](() => {
        ...
        $[_0x1cbc3f(0x177)]({
            ...
            'success': function() {
                ...
                $('#cartCost')[_0xb0b145(0x196)]('' + parseFloat(therapistInformation[_0xb0b145(0x174)] * _0x16466f)['toFixed'](0x2)), $('#subTotal')[_0xb0b145(0x196)]('' + parseFloat(therapistInformation[_0xb0b145(0x174)] * _0x16466f)[_0xb0b145(0x17b)](0x2)), $('#taxTotal')['html']('Kshs.' + parseFloat(therapistInformation['sessionCost'] * _0x16466f * 0.12)[_0xb0b145(0x17b)](0x2)), $('#total')['html']('Kshs.' + parseFloat(therapistInformation['sessionCost'] * _0x16466f * 1.12)['toFixed'](0x2));
            }
        });
    });
}
